...
st.title("Welcome to data bin")
st.markdown("""
Dự án đầu tay của bin
* **Python libary**: Pandas, matplotlib, searborn,...
* **Data source**:https://raw.githubusercontent.com/nv-thang/Data-Visualization-Course/main/Dataset%20for%20Practice/movies.csv 
            """)
